        ...
        <div class="container">
            <div class="order__content">
                ...
                <div class="order__content__buttons">
                    <button @click="valueOrder = 1" :class="{activeValue: valueOrder == 1}">{{ $t('document') }}</button>
                    <button @click="valueOrder = 2" :class="{activeValue: valueOrder == 2}">{{ $t('parcel') }}</button>
                </div>
                ...
                <Map @selectedAddress1="selectedAddress1" @selectedAddress2="selectedAddress2" />
                <!-- {{ address1 }} <br />
                {{ address2 }} -->
                <div class="dateAboutParcel">
                    <div class="dateAboutParcel__box">
                        <p class="dateAboutParcel__box-title">{{ $t('form1') }}</p>
                        <input class="dateAboutParcel__box-input" :placeholder="$t('formDesc1')" v-model="address1.city" />
                    </div>
                    <div class="dateAboutParcel__box">
                        <p class="dateAboutParcel__box-title">{{ $t('form2') }}</p>
                        <input class="dateAboutParcel__box-input" :placeholder="$t('formDesc2')" v-model="address2.city" />
                    </div>
                    <div class="dateAboutParcel__box">
                        <p class="dateAboutParcel__box-title">{{ $t('form3') }}</p>
                        <input class="dateAboutParcel__box-input" :placeholder="$t('formDesc3')"  v-model="address1.street" />
                    </div>
                    <div class="dateAboutParcel__box">
                        <p class="dateAboutParcel__box-title">{{ $t('form4') }}</p>
                        <input class="dateAboutParcel__box-input" :placeholder="$t('formDesc4')" v-model="address2.street" />
                    </div>
                    <div class="dateAboutParcel__box">
                        <p class="dateAboutParcel__box-title">{{ $t('form5') }}</p>
                        <input class="dateAboutParcel__box-input" :placeholder="$t('formDesc5')" v-model="address1.postindex" />
                    </div>
                    <div class="dateAboutParcel__box">
                        <p class="dateAboutParcel__box-title">{{ $t('form6') }}</p>
                        <input class="dateAboutParcel__box-input" :placeholder="$t('formDesc6')" v-model="address2.postindex" />
                    </div>
                    <div class="dateAboutParcel__box">
                        <p class="dateAboutParcel__box-title">{{ $t('form7') }}</p>
                        <input type="date" class="dateAboutParcel__box-input" :placeholder="$t('formDesc7')" v-model="send_date" />
                    </div>
                </div>
                
                <p class="order__content-text4" style="color: black">{{ $t('allDataParcel2') }}</p>

                <div class="dateAboutParcel dateAboutParcel2">
                    <div class="dateAboutParcel__box">
                        <p class="dateAboutParcel__box-title">{{ $t('form8') }}</p>
                        <input class="dateAboutParcel__box-input" :placeholder="$t('formDesc8')" type="text" v-model="sender_name" />
                    </div>
                    <div class="dateAboutParcel__box">
                        <p class="dateAboutParcel__box-title">{{ $t('form9') }}</p>
                        <input class="dateAboutParcel__box-input" :placeholder="$t('formDesc9')" type="text" v-model="sender_phone" />
                    </div>
                    <div class="dateAboutParcel__box">
                        <p class="dateAboutParcel__box-title">{{ $t('form10') }}</p>
                        <input class="dateAboutParcel__box-input" :placeholder="$t('formDesc10')" type="text" v-model="recipient_name" />
                    </div>
                    <div class="dateAboutParcel__box">
                        <p class="dateAboutParcel__box-title">{{ $t('form11') }}</p>
                        <input class="dateAboutParcel__box-input" :placeholder="$t('formDesc9')" type="text" v-model="recipient_phone" />
                    </div>
                    <div class="dateAboutParcel__boxTextarea">
                        <p class="dateAboutParcel__box-title">{{ $t('form12') }}</p>
                        <textarea :placeholder="$t('formDesc11')" v-model="comments" ></textarea>
                    </div>
                </div>

                <p class="order__content-text5">{{ $t('politic') }}.</p>
                <p class="order__content-text6">{{ $t('forPayment') }}: 2500 ₸</p>
                <div class="order__content__buttons2">
                    <button class="order__content__buttons2-b1">{{ $t('close') }}</button>
                    <button class="order__content__buttons2-b2" @click="buyPayment">{{ $t('buyPayment') }}</button>
                </div>
            </div>
        </div>
    </div>
        ...
        buyPayment() {
            if (this.address1 === false || this.address2 === false) {
                ...
                let allDatas = {
                    ...
                    map_data: JSON.stringify([this.address1.coordinates, this.address2.coordinates])
                }
